    ...
    with st.form("my_form"): 
        ...
        try:
            ...
            with st.spinner('Model is getting retrained....'):     
                epoch = 20
                retrain_model = tf.keras.models.load_model('models/retrained_X_test100_79_model.h5')
                ...
                retrain_model.save('models/retrained_Streamlit_model.h5') 
...
classifier_model = 'models/my_model.h5'
model = models.load_model(classifier_model, compile=False, custom_objects={'KerasLayer': hub.KerasLayer})
retrain_model = tf.keras.models.load_model('models/retrained_Streamlit_model.h5')
