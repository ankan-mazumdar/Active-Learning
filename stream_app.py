...
import subprocess
if not os.path.isfile('retrained_model4.h5'):
    subprocess.run(['curl --output retrained_model4.h5 "https://media.githubusercontent.com/media/ankan-mazumdar/Active-Learning/main/retrained_X_test100_79_model.h5"'], shell=True)
retrain_model = tf.keras.models.load_model('retrained_model4.h5') 
...
if not os.path.isfile('retrained_Streamlit_model.h5'):
        ...
        retrain_model = tf.keras.models.load_model('retrained_model4.h5')  
        print('OOPS, unable to fetch retrained streamlit model, hence running untrained model')
