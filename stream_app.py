...
def main():
    ...
    with st.form("my_form"): 
        for uploaded_file in uploaded_files: 
            ...
            choice = st.selectbox("select an option from dropdown if the predicted label is incorrect for above image and then click submit and retrain",['Airplane', 'Automobile', 'Bird', 'Cat', 'Deer', 'Dog', 'Frog', 'Horse', 'Ship', 'Truck'],key = uploaded_file)
